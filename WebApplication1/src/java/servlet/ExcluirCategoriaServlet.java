 ...
 * @author Shelmo
 */
@WebServlet(name = "ExcluirCategoriaServlet", urlPatterns =
{
    "/ExcluirCategoriaServlet"
})
public class ExcluirCategoriaServlet extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        try (PrintWriter out = response.getWriter())
        {
            ...
            response.sendRedirect("ListaCategoriaJSTL.jsp?catExcNome="+request.getParameter("nome"));
            out.println("</body>");
            out.println("</html>");
        }
    }
